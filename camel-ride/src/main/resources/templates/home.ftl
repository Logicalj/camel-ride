...
<div class="maindiv" layout="column" flex layout-fill ng-cloak>
	<header>
    <md-toolbar class="md-hue-2">
      <div class="md-toolbar-tools">
		...
		-->
        <h2 flex md-truncate>Welcome!! Get ready to take off....</h2>
    ...
    <md-tabs md-border-bottom>
      ...
      <md-tab label="three" layout-fill>
        <md-content class="md-padding">
      ...
      <footer style="color: greenyellow;">
          <p>footer</p>
      </footer>
    </div>
</div>
